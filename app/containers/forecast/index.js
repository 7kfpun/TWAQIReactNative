...
import ForecastNotificationSettings from './components/forecast-notification-settings';
        ...
        >
              ...
              <View style={styles.body}>
                {this.state.aqfnResult && this.state.aqfnResult[0] && (
                  <Text style={styles.publishTimeText}>
                    {I18n.t('forecast_publish_time')}
                    {this.state.aqfnResult[0].PublishTime}
                  </Text>
                )}
                      ...
                      {this.state.aqfnResultGroup[
                        ...
                        >
                          <Text style={styles.text}>
                            {moment(item.ForecastDate).format('M/D')}
                          </Text>
                        </View>
                      ))}
                    </View>
                    ...
                    <View>
                      {Object.keys(this.state.aqfnResultGroup).map(key => (
                        ...
                        >
                          ...
                          {this.state.aqfnResultGroup[key].length === 1 && (
                            <View style={{ flex: 1 }} />
                          )}
                          {this.state.aqfnResultGroup[key].length === 1 && (
                            <View style={{ flex: 1 }} />
          ...
          <View>
            ...
            >
              ...
              {this.state.aqfnResult &&
                this.state.aqfnResult[0] &&
                this.state.aqfnResult[0].Content && (
                  <Text style={styles.text}>
                    {getForecastContent(this.state.aqfnResult[0].Content)}
                  </Text>
                )}
            </SwipeScrollView>
